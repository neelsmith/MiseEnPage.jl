...
# ╔═╡ 6b8fd0ca-39c9-11ee-1c90-6d1ca1fa5e4a
begin
	using PlutoUI
	using Luxor
...
# ╔═╡ 20f04a8f-7297-4331-aed7-28f20967e6ad
md"""*To see the Julia environment, unhide the following cell.*"""

# ╔═╡ ce4bd667-9185-4b23-8f62-ae9e13c17828
md"""
> *No released version yet.*
>
> *TBA: add interactive selection of page to evaluate*
"""

# ╔═╡ ff9e1f23-5420-45c6-8523-1218de896f80
md"""# The proximity hypothesis"""

# ╔═╡ e3675f13-311d-4cdd-9fa6-a9b7892553df
md"""> **Data**"""

# ╔═╡ 1a330a9a-ee36-4d6f-982b-eae01a70f451
page_urn = Cite2Urn("urn:cite2:hmt:msA.v1:112r")

# ╔═╡ 0f836012-3241-4a04-b369-1c32056b889f
# ╠═╡ show_logs = false
pg = msPage(page_urn)

# ╔═╡ 9e0c4cd5-5076-4fce-9723-e8c41637c743
md"""> **End results**"""

# ╔═╡ 39ea6ec1-717b-4282-9dd8-c136a45fe3cb
# ╠═╡ show_logs = false
proximity_score = score_by_proximity_y(pg; threshhold = 0.1)

# ╔═╡ 3312b202-b74b-41ee-87d9-5207a34657a7
success_rate(proximity_score)

# ╔═╡ 2cce111c-14b5-441e-b728-d3c9892409d1
md"""> **Alternative scoring**"""

# ╔═╡ d162e2cb-eaaa-4cfc-b8dd-32f838a5e733
# ╠═╡ show_logs = false
score_15 = score_by_proximity_y(pg; threshhold = 0.15)

# ╔═╡ 1812372c-3d09-47ce-8a37-070b5a2a71ef
success_rate(score_15)

# ╔═╡ 12ae0774-adea-4bc6-a7f4-dd9999f4c866
html"""
<br/><br/><br/><br/><br/>
<hr/>
"""

# ╔═╡ 3c093d8b-fd17-4a16-a0b8-f5b0df73bfd1
md"""> **Building the results**"""

# ╔═╡ 21676681-7138-4705-afc1-066558f80930
img = load_rgba(pg; w = 400)

# ╔═╡ 03c29bf7-16ef-446c-928e-6048b08ab67d
# ╠═╡ show_logs = false
...
MiseEnPage = "92bda1c4-f68c-458d-a0a7-9475acb83902"
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "8561fb9c2aade25e01e90c1801790be8facaa4ee"
...
[[deps.MiseEnPage]]
deps = ["CitableBase", "CitableImage", "CitableObject", "CitablePhysicalText", "CitableText", "DocStringExtensions", "Documenter", "Downloads", "FileIO", "HiGHS", "HmtArchive", "Images", "JuMP", "Luxor", "Test", "TestSetExtensions"]
git-tree-sha1 = "d1ec5353940fb1dc8262fed580d40f861d8b1a3e"
uuid = "92bda1c4-f68c-458d-a0a7-9475acb83902"
version = "0.1.1"
